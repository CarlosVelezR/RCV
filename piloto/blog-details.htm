        ...
        <section class="page-banner" style="background-image:url(images/resources/banner.jpg);">
            <div class="container">
                ...
                <ul class="breadcumb">
                    ...
                    <li><a class="active" href="blog-details.htm">Single blog</a></li>
                </ul>
            </div>
        </section>
        <!--End page-banner-->
					...
					<div class="col-md-8 col-sm-12 col-xs-12">
							...
							<article class="single-blog-post style-two">
								<div class="post-inner">
									<div class="image-box">
										<figure><a href="#"><img src="images\blog\16.jpg" alt=""></a></figure>
									</div>
									<div class="post-header">
										<h2><a href="blog-details.htm">Making the Most of Distributed Nemo enim ipsam voluptatem Energy Resources sequi.</a></h2>
										<ul class="post-info">
											<li><span class="flaticon-black"></span>&ensp; by Admin</li>
											<li><span class="fa fa-clock-o"></span>&ensp; Sun, Feb 19  </li>
									...
									<div class="post-desc">
										...
										<div class="text style-two"><p>We’re the leading consulting partner to the private equity industry and its stakeholders. We advise investors across the entire.eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum.</p></div>
									...
									<div class="text"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elitsed do eiusmod tempor incididunt ut labore et dolore magna aliqua Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commo do consequat.</p></div>
								</div>
							</article>
						...
						<div class="comments-area">
							...
							<div class="comment-box">
								<div class="comment wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
									...
									<div class="text">Lorem ipsum dolor sit amet, consectetur adipisicing elitsed do eiusmod tempor incididunt ut labore et dolore magna aliqua Ut enim ad minim veniam.</div>
									<div class="reply-option text-left">Posted 6 hours ago &ensp; <a class="theme-btn radial-btn btn-theme-four" href="#"><span class="txt">Reply</span></a></div>
								</div>
								...
								<div class="comment wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
									...
									<div class="text">Lorem ipsum dolor sit amet, consectetur adipisicing elitsed do eiusmod tempor incididunt ut labore et dolore magna aliqua Ut enim ad minim veniam.</div>
									<div class="reply-option text-left">Posted 4 hours ago &ensp; <a class="theme-btn btn-theme-four" href="#"><span class="txt">Reply</span></a></div>
								</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<aside class="sidebar"> 
							...
							<div class="widget popular-categories wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
								...
								<ul class="list">
									<li><a href=""><span class="icon-left fa fa-chevron-right"></span>Home (8)</a></li>
									<li><a href=""><span class="icon-left fa fa-chevron-right"></span>Water (7)</a></li>
									<li><a href=""><span class="icon-left fa fa-chevron-right"></span>Honste (5)</a></li>
									<li><a href=""><span class="icon-left fa fa-chevron-right"></span>Hotel (9)</a></li>
									<li><a href=""><span class="icon-left fa fa-chevron-right"></span>Landscope (14)</a></li>
								</ul>
							</div>
							...
							<div class="popular_tags wow fadeInUp animated" data-wow-duration="1500ms" style="visibility: visible; animation-name: fadeInUp;">
								...
								<ul>
									<li><a href="#" class="tran3s">Tree Planting</a></li>
									<li><a href="#" class="tran3s">Business</a></li>
									<li><a href="#" class="tran3s">Gardening</a></li>
									<li><a href="#" class="tran3s">Landscape</a></li>
									<li><a href="#" class="tran3s">Watering</a>  </li>
									<li><a href="#" class="tran3s">Lawn</a></li>
									<li><a href="#" class="tran3s">Nature</a> </li>
									<li><a href="#" class="tran3s">Planting</a> </li>
