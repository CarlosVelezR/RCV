        ...
        <section class="page-banner" style="background-image:url(images/resources/banner.jpg);">
            <div class="container">
                ...
                <ul class="breadcumb">
                    ...
                    <li><a class="active" href="error.htm">Error Page</a></li>
                </ul>
            </div>
        </section>
        <!--End page-banner-->
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="content-box">
							...
							<p>Search Anything or Visit our Home Page</p>
							...
							<ul class="link_btn">
								<li><a href="index-1.htm" class="thm-btn style-two">go to home</a></li>
							</ul>
						</div>
