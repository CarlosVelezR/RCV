        ...
        <section class="page-banner" style="background-image:url(images/resources/banner.jpg);">
            <div class="container">
                ...
                <ul class="breadcumb">
                    ...
                    <li><a class="active" href="single-project.htm">Single project</a></li>
                </ul>
            </div>
        </section>
        <!--End page-banner-->
        ...
        <section class="single-project">
            <div class="container">
                <div class="img-holder">
                   <figure><img src="images\service\sp.jpg" alt="Images"></figure>  
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                       <div class="information">
                            <p><i class="fa fa-calendar" aria-hidden="true"></i>Date:<br><span>21st August, 2016</span></p>
                            <p><i class="fa fa-user" aria-hidden="true"></i>Client:<br><span>Green Pvt ltd.</span></p>
                            <p><i class="fa fa-life-ring" aria-hidden="true"></i>Value:<br><span>$27000</span></p>
                            <p><i class="fa fa-map-marker" aria-hidden="true"></i>Location:<br><span>262 Milacina Mrest Street, Behansed, Paris, France</span></p>
                        </div>  
                    </div>       
                </div>
            </div>
