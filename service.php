        ...
        <section class="page-banner" style="background-image:url(images/resources/banner.jpg);">
            <div class="container">
                ...
                <ul class="breadcumb">
                    ...
                    <li><a class="active" href="service.htm">services</a></li>
                </ul>
            </div>
        </section>
        <!--End page-banner-->
                ...
                <div class="service-list">
                    ...
                    <div class="service-carousel">
                           ...
                           <div class="item">
								...
								<div class="text">
                                    <h4><a href="service-single.htm">Tree Plantation</a></h4>
                            ...
                            <div class="item">
								...
								<div class="text">
                                    <h4><a href="service-single.htm">Snow Removal</a></h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
                                    <div class="link-btn">
                                        <a href="service-single.htm">View Services<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                    </div>
                             ...
                             <div class="item">
								...
								<div class="text">
                                    <h4><a href="service-single.htm">Water & Plantation</a></h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
                                    <div class="link-btn">
                                        <a href="service-single.htm">View Services<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="single-choose-item">
                                            ...
                                            <div class="choose-text">
                                                <h4><a href="#">Watering Garden</a></h4>
                                                <p>Lorem ipsum dolor sit amet con sectetur adipisicing elit</p>
                                            </div>
                                        </div>
                                    </div>
