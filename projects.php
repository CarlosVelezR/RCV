        ...
        <section class="page-banner" style="background-image:url(images/resources/banner.jpg);">
            <div class="container">
                ...
                <ul class="breadcumb">
                    ...
                    <li><a class="active" href="projects.htm">Projects</a></li>
                </ul>
            </div>
        </section>
        <!--End page-banner-->
            ...
            <div class="container">            
                ...
                <div class="row masonary-layout filter-layout">
                    <div class="col-md-4 col-sm-6 col-xs-12 filter-item Watering">
                        <div class="project-item">
                            <div class="img-holder">
                                ...
                                <div class="overlay">
                                    <div class="inner">
                                        <a href="single-project.htm"><i class="flaticon-nature-5"></i></a>
                                    </div>
                                </div>
                                <h4><a href="single-project.htm">Garden Planning</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 filter-item Lawn Cleaning">
                        <div class="project-item">
                            <div class="img-holder">
                                <figure><img src="images\project\7.jpg" alt="Awesome Image"></figure>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 filter-item Lawn Cleaning">
                        <div class="project-item">
                            <div class="img-holder">
                                <figure><img src="images\project\8.jpg" alt="Awesome Image"></figure>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 filter-item Lawn Cleaning">
                        <div class="project-item">
                            <div class="img-holder">
                                <figure><img src="images\project\9.jpg" alt="Awesome Image"></figure>
