        ...
        <section class="page-banner" style="background-image:url(images/resources/banner.jpg);">
            <div class="container">
                ...
                <ul class="breadcumb">
                    ...
                    <li><a class="active" href="team.htm">Team</a></li>
                </ul>
            </div>
        </section>
        <!--End page-banner-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                     ...
                     <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="team_member">
                            <div class="img_holder">
                                <img src="images\team\5.jpg" alt="images">
                                <div class="overlay">
                                    <div class="border">
                                        <div class="icon-holder">
                                            <a href="#"><i class="fa fa-facebook"></i></a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="team_member">
                            <div class="img_holder">
                                <img src="images\team\6.jpg" alt="images">
                                <div class="overlay">
                                    <div class="border">
                                        <div class="icon-holder">
                                            <a href="#"><i class="fa fa-facebook"></i></a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="team_member">
                            <div class="img_holder">
                                <img src="images\team\7.jpg" alt="images">
                                <div class="overlay">
                                    <div class="border">
                                        <div class="icon-holder">
                                            <a href="#"><i class="fa fa-facebook"></i></a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="team_member">
                            <div class="img_holder">
                                <img src="images\team\8.jpg" alt="images">
                                <div class="overlay">
                                    <div class="border">
                                        <div class="icon-holder">
                                            <a href="#"><i class="fa fa-facebook"></i></a>
