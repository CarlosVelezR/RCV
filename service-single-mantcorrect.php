        ...
        <section class="page-banner" style="background-image:url(images/resources/single-service.jpg);">
            <div class="container">
                ...
                <ul class="breadcumb">
                    ...
                    <li><a class="active" href="service-single-mantcorrect.htm">Mantenimiento Correctivo</a></li>
                </ul>
            </div>
        </section>
        <!--End page-banner-->
	                        	...
	                        	<div class="col-md-6 col-sm-6">
	                        		<div class="item">
										...
										<div class="text">
		                                    ...
		                                    <div class="link-btn">
		                                        <a href="service-single-install.htm">Ver servicio<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
		                                    </div>
		                                </div>
